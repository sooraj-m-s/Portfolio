...
function validateName(){
  ...
  if(!nameField.match(/^[A-Za-z]+(\s[A-Za-z]+)+$/) ){
...
function validateNumber(){
  ...
  var numberField = document.getElementById('contact-number').value;
  if(numberField.length==0){
      numberError.innerHTML = 'Phone Number required';
      return false;
  }
